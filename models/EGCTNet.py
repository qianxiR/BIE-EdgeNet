...
from models.BGCT_base_model import ASPP_v1, OverlapPatchEmbed, EdgeAddSementic, SementicAddEdge, BilinearUp, Block, EdgeFusion
...
if __name__ == '__main__':
    ...
    Net = EGCTNet(img_size=256, input_nc=3, output_nc=2, embed_dim=32, num_classes=2).to(device)
