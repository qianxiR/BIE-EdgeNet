...
from models.CTD_help_funcs import TwoLayerConv2d, TransformerDecoder, Cross_Attention, Residual2, PreNorm2, \
...
class CTDModel(nn.Module):
    def __init__(self,output_sigmoid=False,output_nc=2):
        super(CTDModel,self).__init__()
        self.EModel = EModel()
...
class EXModel(nn.Module):
    def __init__(self, input_nc=3, output_nc=32,
                 resnet_stages_num=4, backbone='resnet34',
